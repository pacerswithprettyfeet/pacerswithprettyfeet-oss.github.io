...
Dhoni is more complicated. He can get badly stuck against spin, but against pace he resembles the dot-or-six anchors: content to absorb dot balls and postpone his boundary-hitting until the very end (shoutout to Varun Alvakonda and Jarrod Kimber — [MS Dhoni, T20 cricket, and paradoxes](https://open.substack.com/pub/wickets/p/ms-dhoni-t20-cricket-and-paradoxes?r=6tcgk9&utm_campaign=post-expanded-share&utm_medium=web)). His overall effective boundary rate is almost exactly par, but in the death overs it jumps to 5% above expectation.
<iframe 
